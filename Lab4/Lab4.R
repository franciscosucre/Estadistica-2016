...
# p-value de 0.81, no rechazamos H0, varianzas iguales.

var.test(Notas12_13$S3, Notas212_13$S3)
# p-value de 0.07, no rechazamos H0 con una significacia de 3%, varianzas iguales

var.test(Notas12_13$S4, Notas212_13$S4)
# p-value de 0.001, se rechaza H0, varianzas diferentes
...
# p-value de 0.27, no se rechaza H0 con una significancia de 3%, los promedios son iguales.

t.test(Notas12_13$S3, Notas212_13$S3, var.equal = T, conf.level = 0.97)
# p-value de 0.14, no se rechaza H0 con una significancia de 3%, los promedios son iguales.
...
# La segunda, con un p-valor de 0.12 implicaria que se no rechaza H0 aun para un indice de confidencia del 90%,
# que es lo mos alto que uno deberia estar dispuesto a usar.
# La tercera con un p-valor de 0.27 seria igual a la anterior, nunca se deberia rechazar H0 para cualquier prueba
# Cuarta prueba con p-valor de 0.14 implica igual a la anterior
# Quinta prueba con p-valor de 0.75 es igual a la anterior
# Sexta prueba con p-valor de 0.0002 implicaria que siempre deberiamos rechazar H0, y los promedios son diferentes
